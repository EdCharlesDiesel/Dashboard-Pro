...
NAV_SECTIONS: List[tuple] = [
    ...
    ("2 · FILTER THE DAY", [
        NavEntry("DXAU", "06. DXY vs Gold",          "💵", "pages/dxy-gold.py"),
        NavEntry("MACR", "07. Macro Bias",           "🌐", "pages/macro-bias.py"),
        NavEntry("NEWS", "08. News Filter",          "📰", "pages/news-filter.py"),
        NavEntry("CORR", "09. Correlations",         "🔗", "pages/correlations.py"),
        NavEntry("ATR",  "10. ATR Volatility",       "📊", "pages/atr-volatility.py"),
    ]),
    ("3 · WEEKLY BIAS", [
        NavEntry("WEMA", "11. Weekly EMA",           "📉", "pages/weekly-ema.py"),
        NavEntry("WRSI", "12. Weekly RSI",           "📡", "pages/weekly-rsi.py"),
        NavEntry("WSWG", "13. Weekly Swing",         "🔄", "pages/weekly-swing.py"),
    ]),
    ("4 · DAILY CONFIRM", [
        NavEntry("DTRN", "14. Daily Trend",          "📈", "pages/daily-trend.py"),
        NavEntry("DMCD", "15. Daily MACD",           "📊", "pages/daily-macd.py"),
        NavEntry("STRC", "16. Market Structure",     "🏗️", "pages/market-structure.py"),
    ]),
    ("5 · 4H ZONE", [
        NavEntry("4HCZ", "17. 4H Confluence Zone",   "🎯", "pages/4H-confluence-zone.py"),
        NavEntry("CONF", "18. 2/3 Confluence Check", "🔀", "pages/confluence-checker.py"),
    ]),
    ("6 · 15M TRIGGER", [
        NavEntry("15RJ", "19. 15M Rejection",        "🕯️", "pages/15m-rejection.py"),
        NavEntry("15EN", "20. 15M Entry Signal",     "⚡", "pages/15m-entry-signal.py"),
    ]),
    ("7 · RISK & EXECUTE", [
    ...
    ("8 · REVIEW", [
        NavEntry("JRNL", "23. Trade Journal",        "📓", "pages/trade-journal.py"),
        NavEntry("BTST", "24. Backtest Lab",         "🧪", "pages/backtest-workflow.py"),
    ]),
    ("9 · SYSTEM", [
        NavEntry("RPRT", "25. Reports",              "📑", "pages/reports.py"),
        NavEntry("LOGS", "26. System Logs",          "🧾", "pages/system-logs.py"),
    ]),
]
