...
NAV_SECTIONS: List[tuple] = [
    ...
    ("2 · FILTER THE DAY", [
        ...
        NavEntry("SEAS", "11. Seasonality",          "📅", "pages/seasonality.py"),
    ]),
    ("3 · WEEKLY BIAS", [
        NavEntry("WEMA", "12. Weekly EMA",           "📉", "pages/weekly-ema.py"),
        NavEntry("WRSI", "13. Weekly RSI",           "📡", "pages/weekly-rsi.py"),
        NavEntry("WSWG", "14. Weekly Swing",         "🔄", "pages/weekly-swing.py"),
    ]),
    ("4 · DAILY CONFIRM", [
        NavEntry("DTRN", "15. Daily Trend",          "📈", "pages/daily-trend.py"),
        NavEntry("DMCD", "16. Daily MACD",           "📊", "pages/daily-macd.py"),
        NavEntry("STRC", "17. Market Structure",     "🏗️", "pages/market-structure.py"),
    ]),
    ("5 · 4H ZONE", [
        NavEntry("4HCZ", "18. 4H Confluence Zone",   "🎯", "pages/4H-confluence-zone.py"),
