...
_KNOWN_RELATIONSHIPS: List[Tuple[str, str, str, str]] = [
    ...
    ("EUR/USD", "🥇 Gold", "Positive", "Both USD-priced — weak dollar lifts both."),
    ("GBP/USD", "GBP/JPY", "Positive", "GBP leg drives both; JPY adds vol."),
    ("AUD/USD", "🥇 Gold", "Positive", "AU is major gold exporter — AUD tracks gold."),
    ("AUD/USD", "NZD/USD", "Positive", "Commodity-currency bloc."),
    ("USD/CAD", "🥇 Gold", "Negative", "CAD with commodities; Gold USD = inverse."),
    ("USD/JPY", "EUR/JPY", "Positive", "JPY leg dominates in risk-off."),
    ("USD/ZAR", "🥇 Gold", "Negative", "ZAR strengthens with Gold."),
    ...
    ("💵 DXY",  "🥇 Gold",  "Negative", "Gold USD-priced; USD strength suppresses Gold."),
    ...
    ("📈 S&P 500", "🥇 Gold", "Negative", "Gold competes with equities."),
]
